...
install -p -D -m 0644 polkit/org.jfhbrook.plusdeck.policy %{buildroot}%{_prefix}/share/polkit-1/actions/org.jfhbrook.plusdeck.policy
install -p -D -m 0644 polkit/org.jfhbrook.plusdeck.rules %{buildroot}%{_prefix}/share/polkit-1/rules.d/org.jfhbrook.plusdeck.rules
...
%{_prefix}/share/polkit-1/actions/org.jfhbrook.plusdeck.policy
%{_prefix}/share/polkit-1/rules.d/org.jfhbrook.plusdeck.rules
